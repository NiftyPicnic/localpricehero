// Data object
const data = {
    // ... your existing locations, sizes, and prices ...
};

// New function to consolidate prices
function getConsolidatedPrices(data) {
    ...
    data.prices.forEach(priceObj => {
        ...
        Object.keys(priceObj.prices).forEach(size => {
            ...
            consolidatedPrices.push({ location, size, price });
        });
    });
    return consolidatedPrices;
}

// Adding the consolidated prices to the data object
data.consolidatedPrices = getConsolidatedPrices(data);
...
// Exporting the data object
    ...
    prices; [
        ...
        { location: "Woking", prices: { "10sqft": "£40.00", "15sqft": "£60.00", "25sqft": "£100.00", "35sqft": "£140.00", "50sqft": "£200.00", "75sqft": "£300.00", "100sqft": "£400.00", "125sqft": "£500.00", "150sqft": "£600.00", "175sqft": "£700.00", "200sqft": "£800.00", "250sqft": "£1000.00", "300sqft": "£1200.00", "500sqft": "£2000.00" }}
        // ... continue with other cities as needed ...
    ],
};
